...
public class Home extends Fragment implements IHome, MainActivity.search {
    RecyclerView list;
    IPHome ipHome;
    MainActivity main;
    String tenmonan;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        anhxa(view);
        ipHome = new PHome(this,getContext());
        ipHome.LoadData();
//        ipHome.Search(tenmonan);
    }
    ...
    @Override
    public void LoadData(List<DoAn> data, Adapter_home adapter) {

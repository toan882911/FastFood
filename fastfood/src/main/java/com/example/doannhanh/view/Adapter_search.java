...
public class Adapter_search extends RecyclerView.Adapter{
    ...
    List<Search> data = Collections.emptyList();
    Adapter_search adapter = this;
    public Adapter_search(Context context, List<Search> data) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        final Search current = data.get(position);

...
public class Adapter_food extends RecyclerView.Adapter{
    private Context context;
    private LayoutInflater inflater;
    List<Food> data = Collections.emptyList();
    Adapter_food adapter = this;
    public Adapter_food(Context context, List<Food> data) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        final Food current = data.get(position);
